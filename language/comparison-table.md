...
Below is a list of literal types/lexemes: Built-in and supported by PHP (except marked by "⚠️" sign).
...
| Binary Scientific `0b10e2` _(⚠️ PHP non-standard)_      | ❌                                               | ❌                                         | ❌                                                                     |
| Octal Scientific `0o42e2` _(⚠️ PHP non-standard)_       | ❌                                               | ❌                                         | ❌                                                                     |
| Legacy Octal Scientific `042e2` _(⚠️ PHP non-standard)_ | ❌                                               | ❌                                         | ❌                                                                     |
