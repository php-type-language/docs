...
The `@phpstan-property-read` tag is PHPStan's vendor-specific
`@property-read` alias. It is the vendor-prefixed spelling of
[@property-read](property-read-tag.md), which this component
